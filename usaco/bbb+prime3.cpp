...
void my_break_down(vector<int> vp){
    ...
    for(int i=0; i<cnt; i++){
        int a = primes[i][1], b = primes[i][3];
        primes_second[a][b][c_second[a][b]] = i;
        c_second[a][b]++;
    }
    for(int i=0; i<cnt; i++){
        int a = primes[i][2];
        ...
        for(int i=0; i<sz; i++){
            ...
            for(int j=0; j<sz; j++){
                ...
                for(int a=0; a<a_sz; a++){
                    ...
                    int b_sz = c_second[b_x][b_y];
                    for(int b = 0; b<b_sz; b++){
                        int idx_b = primes_second[b_x][b_y][b];
                        ...
                        for(int c=0; c<c_sz; c++){
                            ...
                            int d_sz = c_second[d_x][d_y];
                            for(int d=0; d<d_sz; d++){
                                int idx_d = primes_second[d_x][d_y][d];
